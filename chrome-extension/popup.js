...
const TOOLS = [
  ...
  { name: "SQL Dialect Converter",    url: "/developer/sql-dialect-converter", icon: "🔄", category: "developer" },
  { name: "Markdown Preview",         url: "/developer/markdown-preview",      icon: "👁️", category: "developer" },
  { name: "Markdown to HTML",         url: "/developer/markdown-to-html",      icon: "📝", category: "developer" },
  { name: "HTML to Markdown",         url: "/developer/html-to-markdown",      icon: "📄", category: "developer" },
