...
export default function PngToWebpPage() {
  ...
  function convert(f: File) {
    ...
    img.onload = () => {
      ...
      canvas.toBlob(
        (blob) => {
          if (!blob) {
            setError("Conversion failed. Your browser may not support WebP encoding.");
            setStatus("error");
            return;
          }
          setResultBlob(blob);
  ...
  function handleDownload() {
    ...
    a.href = resultUrl;
    a.download = `converted-${baseName}.webp`;
    a.click();
  }
        ...
        {!file ? (
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">PNG — max 10 MB</p>
            </div>
            <input
              ref={inputRef}
              type="file"
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium">Converted (WebP)</label>
                  {resultBlob && (
                ...
                <div className="flex h-64 items-center justify-center overflow-hidden rounded-lg border border-border bg-muted/20">
                  {resultUrl ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img src={resultUrl} alt="Converted WebP" className="max-h-full max-w-full object-contain" />
                  ) : (
            ...
            {status === "done" && resultBlob && (
              <div className="flex flex-wrap items-center gap-3 rounded-lg border border-green-500/30 bg-green-500/10 px-4 py-3">
                ...
                <span className="text-sm font-medium text-green-700 dark:text-green-400">
                  {savings > 0 ? `Saved ${savings}%` : "Conversion complete"}
                </span>
